...
//#####WARNING - THIS PART CAN CASE A LINKER MISTAKE#######
#define OCTYPE float                                    //#
//#########################################################
...
CEREAL_REGISTER_TYPE(CNodeBranch<float>);
CEREAL_REGISTER_TYPE_WITH_NAME(CNodeLeaf<float>, "CNodeLeaf");
...
CEREAL_REGISTER_POLYMORPHIC_RELATION(CNode<float>, CNodeBranch<float>);
CEREAL_REGISTER_POLYMORPHIC_RELATION(CNode<float>, CNodeLeaf<float>);
